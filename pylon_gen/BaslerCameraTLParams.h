...
namespace BaslerCameraTLParams_Params
{
    ...
    */
    ...
    //@{
    /*!
        \brief Enables sending all commands and receiving all acknowledges twice - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Enables the automatic start of the PylonGigEConnectionGuard - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Heartbeat timeout value on the host side in milliseconds - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum number of retries for read operations after a read operation has timed out - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum number of retries for write operations after a write operation has timed out - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Enables mapping of certain SFNC 1 x node names to SFNC 2 x node names - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Read access timeout value in milliseconds - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Number of timeouts during read and write operations when waiting for a response from the device - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Write access timeout in milliseconds - Applies to: acA1600-60gc
