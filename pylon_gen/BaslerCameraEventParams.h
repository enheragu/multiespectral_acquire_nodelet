...
namespace BaslerCameraEventParams_Params
{
    ...
    enum StatusEnums
    {
        Status_Closed,  //!< The low level event grabber is closed - Applies to: acA1600-60gc
        Status_Open  //!< The low level event grabber is open - Applies to: acA1600-60gc
    };
    ...
    */
    ...
    //@{
    /*!
        \brief Firewall traversal interval value in milliseconds  This applies to the event channel  If set to 0, this feature is disabled - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Number of buffers to be used - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum number of retries - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief For internal use only - Applies to: acA1600-60gc
    ...
    */
    ...
    //@{
    /*!
        \brief Acknowledge timeout in milliseconds - Applies to: acA1600-60gc
